...
- 待補原文核心：**52** 部，橫跨 **14** 宗教

## 古埃及（8 部）

- [ ] `book-of-am-tuat` 阿姆杜阿特之書（幽冥界之書）（English (Budge translation)）— 未譯，原文待補
- [ ] `book-of-gates` 門之書（English (Budge translation)）— 未譯，原文待補
- [ ] `burden-of-isis` 伊西斯的悲歌（奧西里斯讚歌）（English (Budge translation)）— 未譯，原文待補
- [ ] `egyptian-book-of-dead` 古埃及死者之書（English (Budge translation)）— 未譯，原文待補
- [ ] `egyptian-heaven-and-hell` 埃及的天堂與地獄（English (Budge translation)）— 未譯，原文待補
...
- [ ] `plato-works` 柏拉圖對話集 (sacred-texts 選)（English (translation)）— 未譯，原文待補
