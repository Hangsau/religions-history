...
QUOTA_INTERVAL_RESERVE_PERCENT = float(os.environ.get("RELIGIONS_QUOTA_INTERVAL_RESERVE", "5"))
QUOTA_WEEKLY_RESERVE_PERCENT = float(os.environ.get("RELIGIONS_QUOTA_WEEKLY_RESERVE", "2"))
